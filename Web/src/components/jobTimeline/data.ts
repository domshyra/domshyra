...
export const jobDescription: JobDetails[] = [
	{
		...
		bullets: [
			...
			"Communicated across multiple departments by translating complex technical concepts into terminology and analogies tailored to each team’s domain, ensuring shared understanding and alignment.",
		],
	...
	},
	{
		...
		bullets: [
			...
			"Advocated for stronger testing practices and consistently added new tests when defects were discovered to prevent regressions.",
